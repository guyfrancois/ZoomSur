 ...
 */
class site.connexe.MediaEtHtml  implements site.connexe.I_connexeContenu {
	...
	public function MediaEtHtml(clip:MovieClip,xmlFile:String,cssFile:String) {
	
		this.xmlFile=xmlFile;
		this.cssFile=cssFile;
		
		htmlZone=clip.attachMovie("ecranMediaHtml","htmlZone",1);
    ...
    private function afficheMedia(media){
