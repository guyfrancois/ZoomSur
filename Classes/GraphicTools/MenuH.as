...
/**
  ...
  *   */
class GraphicTools.MenuH extends EventDispatcher {
	...
	public function MenuH(clip:MovieClip,arboMenu:Object,margeHaute:Number,autoSubOpen:Boolean) {
		super();
		selected=false;
 ...
 * internal, reservé à la fermeture du clip (enterFrame) */
	...
	private function createChild_Menu(child:MovieClip,decalageY:Number,autoSubOpen:Boolean,struct:Object){
		return new GraphicTools.MenuVOver(child,struct,child._y-decalageY,autoSubOpen);
	}
	/**
	...
	private function _onClosed(src:MenuH){
